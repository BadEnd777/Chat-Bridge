...
const config: DocsThemeConfig = {
  ...
  head: function useHead() {
    ...
    const socialCard = "https://cdn.discordapp.com/attachments/1157951067284312114/1194558135948562443/chat-bridge-more-clean.png"
    ...
    return (
      <>
        ...
        <meta
          name="og:title"
          content={title ? `${title} — Chat Bridge` : 'Chat Bridge'}
        />
