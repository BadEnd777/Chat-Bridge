...
<Cards>
    ...
    <Card icon={<FaFile />} title="Static file server" href="#static-file-server" alt="Static file server" arrow />
...
-   `options`: Chat Bridge use [@fastify-static](https://github.com/fastify/fastify-static) plugin of Fastify. You can
    pass any options that are supported by the plugin.
